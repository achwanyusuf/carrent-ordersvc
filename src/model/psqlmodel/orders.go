...
type Order struct {
	...
	PickupDate      time.Time `boil:"pickup_date" json:"pickup_date" toml:"pickup_date" yaml:"pickup_date"`
	DropoffDate     time.Time `boil:"dropoff_date" json:"dropoff_date" toml:"dropoff_date" yaml:"dropoff_date"`
	PickupLocation  string    `boil:"pickup_location" json:"pickup_location" toml:"pickup_location" yaml:"pickup_location"`
	PickupLat       float64   `boil:"pickup_lat" json:"pickup_lat" toml:"pickup_lat" yaml:"pickup_lat"`
	PickupLong      float64   `boil:"pickup_long" json:"pickup_long" toml:"pickup_long" yaml:"pickup_long"`
	DropoffLocation string    `boil:"dropoff_location" json:"dropoff_location" toml:"dropoff_location" yaml:"dropoff_location"`
	DropoffLat      float64   `boil:"dropoff_lat" json:"dropoff_lat" toml:"dropoff_lat" yaml:"dropoff_lat"`
	DropoffLong     float64   `boil:"dropoff_long" json:"dropoff_long" toml:"dropoff_long" yaml:"dropoff_long"`
...
var OrderTableColumns = struct {
	...
	PickupDate:      "orders.pickup_date",
	DropoffDate:     "orders.dropoff_date",
	PickupLocation:  "orders.pickup_location",
	PickupLat:       "orders.pickup_lat",
	PickupLong:      "orders.pickup_long",
	DropoffLocation: "orders.dropoff_location",
	DropoffLat:      "orders.dropoff_lat",
	DropoffLong:     "orders.dropoff_long",
	CreatedBy:       "orders.created_by",
	CreatedAt:       "orders.created_at",
	UpdatedBy:       "orders.updated_by",
	UpdatedAt:       "orders.updated_at",
	DeletedBy:       "orders.deleted_by",
...
var OrderWhere = struct {
	...
	PickupDate      whereHelpertime_Time
	DropoffDate     whereHelpertime_Time
	PickupLocation  whereHelperstring
	PickupLat       whereHelperfloat64
	PickupLong      whereHelperfloat64
	DropoffLocation whereHelperstring
	DropoffLat      whereHelperfloat64
	DropoffLong     whereHelperfloat64
	...
	CarID:           whereHelperint{field: "\"orders\".\"car_id\""},
	OrderDate:       whereHelpertime_Time{field: "\"orders\".\"order_date\""},
	PickupDate:      whereHelpertime_Time{field: "\"orders\".\"pickup_date\""},
	DropoffDate:     whereHelpertime_Time{field: "\"orders\".\"dropoff_date\""},
	PickupLocation:  whereHelperstring{field: "\"orders\".\"pickup_location\""},
	PickupLat:       whereHelperfloat64{field: "\"orders\".\"pickup_lat\""},
	PickupLong:      whereHelperfloat64{field: "\"orders\".\"pickup_long\""},
	DropoffLocation: whereHelperstring{field: "\"orders\".\"dropoff_location\""},
	DropoffLat:      whereHelperfloat64{field: "\"orders\".\"dropoff_lat\""},
	DropoffLong:     whereHelperfloat64{field: "\"orders\".\"dropoff_long\""},
	CreatedBy:       whereHelperint{field: "\"orders\".\"created_by\""},
	CreatedAt:       whereHelpertime_Time{field: "\"orders\".\"created_at\""},
	UpdatedBy:       whereHelperint{field: "\"orders\".\"updated_by\""},
	UpdatedAt:       whereHelpertime_Time{field: "\"orders\".\"updated_at\""},
	DeletedBy:       whereHelpernull_Int{field: "\"orders\".\"deleted_by\""},
...
var (
	orderAllColumns            = []string{"id", "car_id", "order_date", "pickup_date", "dropoff_date", "pickup_location", "pickup_lat", "pickup_long", "dropoff_location", "dropoff_lat", "dropoff_long", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
	orderColumnsWithoutDefault = []string{"car_id", "order_date", "pickup_date", "dropoff_date", "pickup_location", "pickup_lat", "pickup_long", "dropoff_location", "dropoff_lat", "dropoff_long"}
	orderColumnsWithDefault    = []string{"id", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
...
func (q orderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: failed to execute a one query for orders")
	}
...
func (q orderQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psqlmodel: failed to assign all query results to Order slice")
	}
...
func (q orderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to count orders rows")
	}
...
func (q orderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: failed to check if orders exists")
	}
...
func (o *Order) Car(mods ...qm.QueryMod) carQuery {
...
func (orderL) LoadCar(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrder interface{}, mods queries.Applicator) error {
	var slice []*Order
	var object *Order
	...
	query := NewQuery(
		...
		qmhelper.WhereIsNull(`cars.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetCarG of the order to the related item.
// Sets o.R.Car to related.
// Adds o to related.R.Orders.
// Uses the global database handle.
func (o *Order) SetCarG(ctx context.Context, insert bool, related *Car) error {
	return o.SetCar(ctx, boil.GetContextDB(), insert, related)
}

// SetCar of the order to the related item.
// Sets o.R.Car to related.
// Adds o to related.R.Orders.
func (o *Order) SetCar(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Car) error {
	var err error
	if insert {
...
func FindOrderG(ctx context.Context, iD int, selectCols ...string) (*Order, error) {
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: unable to select from orders")
	}
...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psqlmodel: no orders provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to insert into orders")
	}
...
func (o *Order) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psqlmodel: unable to update orders, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update orders row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by update for orders")
	}
...
func (q orderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all for orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected for orders")
	}
...
func (o OrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all in order slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected all in update all order")
	}
	return rowsAff, nil
}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("psqlmodel: no orders provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psqlmodel: unable to upsert orders, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(orderPrimaryKeyColumns) == 0 {
				return errors.New("psqlmodel: unable to upsert orders, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to upsert orders")
	}
...
func (o *Order) DeleteG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("psqlmodel: no Order provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by delete for orders")
	}
...
func (q orderQuery) DeleteAllG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (q orderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psqlmodel: no orderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by deleteall for orders")
	}
...
func (o OrderSlice) DeleteAllG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from order slice")
	}
...
func (o *Order) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: no Order provided for reload")
	}
...
func (o *OrderSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: empty OrderSlice provided for reload all")
	}
...
func (o *OrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to reload all in OrderSlice")
	}
...
func OrderExistsG(ctx context.Context, iD int) (bool, error) {
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: unable to check if orders exists")
	}
